        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-4 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <div className="p-2 bg-slate-50 border border-slate-200 rounded-xl focus-within:bg-white focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all flex flex-wrap items-center gap-1.5 min-h-[42px]">
                {assigneesList.map((name, idx) => (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded-lg text-xs font-bold animate-fadeIn"
                  >
                ...
                <input
                  ...
                  placeholder={assigneesList.length === 0 ? "พิมพ์ชื่อ เช่น เอก, มอส..." : "+ เพิ่มอีกคน..."}
                  className="flex-1 min-w-[120px] bg-transparent text-xs text-slate-800 placeholder-slate-400 focus:outline-none py-1"
                />
              </div>
                      ...
                      <button
                        ...
                        className={`text-[10px] px-1.5 py-0.5 rounded-md border transition-all ${
                          isAdded
                            ...
                            : 'bg-white hover:bg-indigo-50 text-slate-600 hover:text-indigo-600 border-slate-200 hover:border-indigo-300 cursor-pointer'
                        }`}
                      >
                        + {u}
                      </button>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 min-h-[42px]"
              />
            </div>
          </div>
